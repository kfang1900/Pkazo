        ...
        >
          {isMobile && (
            <div tw="w-full flex items-center justify-between gap-x-4 px-5 py-[18px] border-b border-b-[#E2E2E2]">
              ...
              <button
                ...
                onClick={() => {
                  if (!portfolio.name) {
                    alert('Please enter a name for this portfolio.');
                    return;
                  } else if (!portfolio.picture) {
                    alert('Please enter an image for this portfolio.');
                    return;
                  }
                  onSave();
                  setMobileWorkPopup(false);
          ...
          {isMobile && mobileWorkPopup ? (
            <div tw="z-50 h-full p-6 overflow-auto">
              <div tw="grid grid-cols-[repeat(auto-fill, minmax(120px, 1fr))] gap-x-5 gap-y-3 mr-[-10px] pr-[10px]">
                {portfolio.works.map((work, i) => (
                  <div tw="relative" key={i}>
                    <div tw="mt-2 w-full rounded-[5px] relative overflow-hidden">
                      <div tw="block pb-[100%]" />
                      <Image
                        src={work}
                        layout="fill"
            ...
            <div
              css={[
                isMobile &&
                  tw`px-5 pb-6 overflow-auto h-full flex flex-col justify-between`,
              ]}
            >
              <div>
                <div
                ...
                >
                  <FileUploader
                    ...
                    name={
                      // Upstream issue: when the name attribute is not set, the upload dialogue shows twice.
                      'file'
                    }
                  >
                    <div tw="relative cursor-pointer">
                      ...
                      <div tw="absolute right-1 bottom-1 md:right-3 md:bottom-3">
                        <div tw="cursor-pointer w-[34px] h-[34px] rounded-full bg-black opacity-70 hover:opacity-60 flex items-center justify-center">
                          <Image
                ...
                <div tw="mt-4 md:mt-8 text-[#575757] text-[16px]">
                  Upload the works that belong in this portfolio. For now, only
                  one image per work.
                </div>
                <div
                        ...
                        <div
                          ...
                          onClick={() => {
                            setPortfolio({
                              ...portfolio,
                              works: [
                                ...portfolio.works.filter((x) => x !== work),
                              ],
                            });
                          }}
                        >
          ...
          {!isMobile && (
            <div tw="mt-7 flex justify-end gap-x-4">
              <button
                css={[
                  buttons.white,
                  tw`w-[120px] h-[46px] flex items-center justify-center`,
                ]}
                onClick={onCancel}
                type="button"
              >
  ...
  return (
    <Form>
      <PortfolioPopup
        ...
        onSave={() => {
          setFieldValue('portfolios', [
            ...values.portfolios.slice(0, popupIndex),
            curPortfolio,
            ...values.portfolios.slice(popupIndex + 1),
          ]);
          setPopupIndex(-1);
        }}
        onCancel={() => {
                ...
                <div key={i}>
                  <div tw="w-full h-[108px] relative">
                    <div
                      ...
                      css={[
                        i <= values.portfolios.length && tw`cursor-pointer`,
                      ]}
                      onClick={() => {
