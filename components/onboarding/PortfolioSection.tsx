                ...
                <div css={[isMobile ?
                    ...
                    <div css={[isMobile && tw`px-5 pb-10 overflow-auto`]}>
                        ...
                        >
                            <div tw='relative'>
                                ...
                                <div tw='absolute right-1 bottom-1 md:right-3 md:bottom-3'>
                                    ...
                                    >
                                        <button tw='w-[34px] h-[34px] rounded-full bg-black opacity-70 hover:opacity-60 flex items-center justify-center' type='button'>
                                            <Image
                        ...
                        <div tw='mt-8 text-[#575757] text-[16px]'>
                            Upload the works that belong in this portfolio. For now, only one image per work.
                        </div>
                        <div tw='mt-4 grid grid-flow-col gap-5 overflow-auto justify-start'>
                            {portfolio.works.map((work, i) => (
                                <div tw='w-[110px] h-[110px] rounded-[5px] relative overflow-hidden' key={i}>
                                    <Image
                                        src={work}
                                        layout='fill'
                                        objectFit='cover'
                        ...
                        <FileUploader
                            ...
                            handleChange={(files: File[]) => {
                                setPortfolio({
                                    ...portfolio,
                                    works: portfolio.works.concat(Array(...files).map(URL.createObjectURL))
                                })
        ...
        <Form>
            ...
            >
                <div tw='grid md:grid-cols-5 gap-y-6 gap-x-10 items-start'>
                    {[...Array(5)].map((_, i) => ((!isMobile || i <= values.portfolios.length) &&
                        <div
                            key={i}
                        >
                            <div
                            ...
                            >
                                ...
                                {i === values.portfolios.length &&
                                    <div
                                        tw='w-full h-full flex items-center justify-center bg-[#F3F3F3] hover:bg-[#EFEFEF]'
                                    >
                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <rect x="13" width="4" height="30" rx="3" fill="#C4C4C4" />
                                            <rect y="13" width="30" height="4" rx="3" fill="#C4C4C4" />
                                        </svg>
                                    </div>
                                }
                            </div>
