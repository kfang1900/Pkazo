    ...
    <>
      <div
        css={[
          ...
          tw`fixed top-0 left-0 z-50 flex w-full h-full lg:h-screen lg:overflow-y-auto p-4 lg:p-10 items-center justify-center bg-black bg-opacity-70`,
        ]}
      >
        <div tw="relative flex min-h-full w-full p-8 bg-white rounded-lg lg:rounded-2xl">
          <button
